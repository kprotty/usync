...
//! This forces accesses to the other memory region to be refetched from main-memory (RAM)
//! or at least resynchronized with other CPU caches.
//! To avoid this, we place the (heavily contended) memory being written on its own cache-line
//! which avoids invalidating other nearby cache-lines.
